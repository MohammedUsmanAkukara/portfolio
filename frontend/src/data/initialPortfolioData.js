export const colorPresets = [
  { id: 'indigo', name: 'Cyber Indigo', primary: '#6366f1', primaryHover: '#4f46e5', secondary: '#06b6d4', accent: '#f43f5e' },
  { id: 'emerald', name: 'Emerald Forest', primary: '#10b981', primaryHover: '#059669', secondary: '#3b82f6', accent: '#f59e0b' },
  { id: 'rose', name: 'Sunset Rose', primary: '#e11d48', primaryHover: '#be123c', secondary: '#8b5cf6', accent: '#f97316' },
  { id: 'violet', name: 'Royal Violet', primary: '#8b5cf6', primaryHover: '#7c3aed', secondary: '#ec4899', accent: '#38bdf8' },
  { id: 'amber', name: 'Golden Amber', primary: '#d97706', primaryHover: '#b45309', secondary: '#10b981', accent: '#ef4444' },
  { id: 'cyan', name: 'Neon Cyber', primary: '#0891b2', primaryHover: '#0e7490', secondary: '#6366f1', accent: '#10b981' }
];
